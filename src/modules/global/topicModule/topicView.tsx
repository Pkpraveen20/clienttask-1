  ...
  if (error || !topic) {
    return (
      <div className="text-center py-8">
        <p className="text-red-500">Topic not found or error loading data.</p>
        <button
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-800 text-lg">{topic.topicname}</p>
            </div>
            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
              <h3 className="text-lg font-semibold text-yellow-900 mb-2">
                Start Date
              </h3>
              <p className="text-yellow-800 text-lg">{topic.topicstartdate}</p>
            </div>
        ...
        <div className="bg-gray-50 px-8 py-4 border-t border-gray-200">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600">topic ID: {topic.id}</p>
            <button
              onClick={() => navigate({ to: "/topic" })}
